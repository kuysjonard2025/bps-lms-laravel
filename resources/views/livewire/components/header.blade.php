<div x-data="{
    ...
    <header class="bg-white border-b border-gray-200 px-4 lg:px-6 py-4 flex items-center justify-between shadow-xs sticky top-0 z-30">
        <div class="flex items-center gap-3">
            ...
            <a wire:navigate href="{{ route('dashboard') }}" class="flex flex-col cursor-pointer hover:opacity-80 transition-opacity">
                <span class="text-lg lg:text-xl font-bold tracking-tight text-blue-600 whitespace-nowrap">Bicutan Parochial School</span>
                <p class="text-xs text-gray-600 whitespace-nowrap">Library Management System</p>
            </a>
        </div>
        ...
        <div class="flex items-center gap-2 lg:gap-4">
            ...
            >
                ...
                <span class="hidden sm:inline whitespace-nowrap">{{ auth()->user()->first_name }} {{ auth()->user()->last_name }} - <span class="capitalize bg-blue-100 text-blue-700 px-2 py-1 rounded-full">{{ str(auth()->user()->role)->replace('_', ' ') }}</span></span>
            </button>
