            ...
            <div class="relative bg-white rounded-xl shadow-2xl w-full max-w-xl z-10 overflow-hidden my-auto flex flex-col max-h-[90vh]">
                ...
                <form wire:submit="saveAcquisition" class="p-4 sm:p-6 space-y-4 overflow-y-auto">
                    ...
                    <div>
                        ...
                        <select wire:model.live="catalog_id" class="mt-1 w-full text-xs rounded-md border-gray-300 border p-2 shadow-xs bg-white outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <textarea wire:model="remarks" rows="2" class="mt-1 w-full text-xs rounded-md border-gray-300 border p-2 shadow-xs outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500" placeholder="Additional notes or receiving status..."></textarea>
