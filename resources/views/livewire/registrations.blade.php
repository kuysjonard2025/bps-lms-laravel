                ...
                <form wire:submit="saveUser" class="p-4 sm:p-6 space-y-4 overflow-y-auto">
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="u_last_name" placeholder="Doe" class="mt-1 w-full text-xs rounded-md border-gray-300 border p-2 shadow-xs">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="u_username" placeholder="johndoe" class="mt-1 w-full text-xs rounded-md border-gray-300 border p-2 shadow-xs">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="u_address" placeholder="123 Main St..." class="mt-1 w-full text-xs rounded-md border-gray-300 border p-2 shadow-xs">
                ...
                <form wire:submit="savePatron" class="p-4 sm:p-6 space-y-4 overflow-y-auto">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="text" wire:model="p_patron_id" placeholder="PAT-00123" class="mt-1 w-full text-xs rounded-md border-gray-300 border p-2 shadow-xs">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        ...
                        <div>
                            <label class="block text-xs font-medium text-gray-700">Middle Name *</label>
                            <input type="text" wire:model="p_middle_name" placeholder="M." class="mt-1 w-full text-xs rounded-md border-gray-300 border p-2 shadow-xs">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        ...
                        @if ($isStudentType)
                            ...
                            <div>
                                ...
                                <select wire:model="p_section_id" class="mt-1 w-full text-xs rounded-md border-gray-300 border p-2 shadow-xs bg-white" {{ empty($availableSections) ? 'disabled' : '' }}>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div>
                            <label class="block text-xs font-medium text-gray-700">Email Address *</label>
                            <input type="email" wire:model="p_email" placeholder="jane@example.com" class="mt-1 w-full text-xs rounded-md border-gray-300 border p-2 shadow-xs">
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-700">Address *</label>
                        <input type="text" wire:model="p_address" placeholder="456 Park Ave..." class="mt-1 w-full text-xs rounded-md border-gray-300 border p-2 shadow-xs">
