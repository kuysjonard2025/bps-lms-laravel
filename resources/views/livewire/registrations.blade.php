                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse($users as $user)
                            <tr wire:key="user-{{ $user->id }}" class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-xs text-gray-900">{{ $user->email ?? 'N/A' }}</div>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-8 text-center text-gray-500">No assistant users found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm text-gray-600">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-8 text-center text-gray-500">No registered borrowers found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
