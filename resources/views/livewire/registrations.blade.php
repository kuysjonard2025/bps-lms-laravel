            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm text-gray-600">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="px-6 py-8 text-center text-gray-500">No assistant users found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <div class="bg-white rounded-xl shadow-xl max-w-md w-full p-6 border border-gray-200 space-y-4">
                <div class="text-center space-y-2">
                    ...
                    <p class="text-sm text-gray-500">
                        Are you sure you want to delete this {{ $deleteType === 'user' ? 'assistant user' : 'borrower' }} record? This action cannot be undone.
                    </p>
                </div>

                <div class="flex justify-center gap-3 pt-4 border-t border-gray-200">
                    <button type="button" wire:click="$set('showDeleteModal', false)" class="px-4 py-2 border border-gray-300 rounded-lg text-xs font-medium text-gray-700 hover:bg-gray-50">
                        Cancel
                    </button>
                    <button type="button" wire:click="deleteRecord" wire:loading.attr="disabled" class="px-4 py-2 bg-rose-600 hover:bg-rose-700 text-white rounded-lg text-xs font-medium flex items-center gap-2">
