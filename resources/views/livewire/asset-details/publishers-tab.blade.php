    ...
    <div class="overflow-x-auto border border-gray-200 rounded-lg">
        <table class="w-full text-left text-xs lg:text-sm text-gray-700">
            <thead class="bg-gray-50 text-gray-500 uppercase tracking-wider text-[11px] border-b border-gray-200">
                <tr>
                    <th scope="col" class="px-4 py-3">Publisher Name</th>
    ...
    @if ($showModal)
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
            ...
            <div class="relative bg-white rounded-xl shadow-2xl w-full max-w-md z-10 overflow-hidden my-8">
                ...
                <form wire:submit="savePublisher" class="p-6 space-y-4">
                    <div>
                        <label class="block text-xs font-medium text-gray-700">Publisher Name *</label>
                        <input type="text" wire:model="name" maxlength="50" class="mt-1 w-full text-sm rounded-md border-gray-300 shadow-xs border p-2">
                    ...
                    <div class="mt-5 flex justify-end gap-3">
                        ...
                        <button type="submit" class="px-4 py-2 text-xs font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700 cursor-pointer">
                            {{ $publisherIdBeingEdited ? 'Save Changes' : 'Create Publisher' }}
                        </button>
                    </div>
                </form>
            </div>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div class="relative bg-white rounded-xl shadow-2xl w-full max-w-sm z-10 p-6 text-center space-y-4">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-1">Are you sure you want to delete this publisher? This action cannot be undone.</p>
                </div>
                ...
                <div class="flex justify-center gap-3 pt-2">
                    ...
                    <button wire:click="deletePublisher" type="button" class="px-4 py-2 text-xs font-medium text-white bg-red-600 rounded-md hover:bg-red-700 cursor-pointer">Delete</button>
                </div>
            </div>
        </div>
    @endif
